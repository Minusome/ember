...
class BipartiteSat:
    """
    Extension of bipartite template-based minor embedding to allow embedding on Chimera graph with 
    faults. Constraint programming formulation implemented using Google's OR-Tools, both python 
